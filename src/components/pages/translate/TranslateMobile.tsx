...
export default function TranslateMobile() {
  ...
  const handleTranslation = async (text: string) => {
    console.log("TranslateMobile - Starting translation with text:", text);
    setIsLoading(true);
    try {
      // Use the enhanced translation logic
      console.log("TranslateMobile - Setting spoken language text:", text);
      setSpokenLanguageText(text);

      console.log("TranslateMobile - Calling changeTranslation...");
      await changeTranslation();

      console.log("TranslateMobile - Translation completed successfully");
